...
export const DUMMY_DAILY_REPORTS: DailyReportRow[] = [
  { date: '2026-03-20', submittedBy: 'Raj Kumar', crew: 48, weather: 'Sunny · 33°C', status: 'Pending' },
  { date: '2026-03-19', submittedBy: 'Priya Shah', crew: 52, weather: 'Partly cloudy · 31°C', status: 'Approved' },
  { date: '2026-03-18', submittedBy: 'Raj Kumar', crew: 44, weather: 'Light rain · 28°C', status: 'Approved' },
  { date: '2026-03-17', submittedBy: 'Amit Verma', crew: 39, weather: 'Sunny · 32°C', status: 'Approved' },
  { date: '2026-03-16', submittedBy: 'Priya Shah', crew: 41, weather: 'Cloudy · 30°C', status: 'Rejected' },
  { date: '2026-03-15', submittedBy: 'Raj Kumar', crew: 46, weather: 'Sunny · 34°C', status: 'Approved' },
  { date: '2026-03-14', submittedBy: 'Site Sup.', crew: 38, weather: 'Windy · 29°C', status: 'Draft' },
];

/** March 2026 — day 1 = Sunday. Dot colors: green approved, blue pending, amber draft, red missing, gray weekend */
export type CalendarDot = 'approved' | 'pending' | 'draft' | 'missing' | 'weekend';

export const DUMMY_MARCH_2026_DAYS: { day: number; dot: CalendarDot }[] = [
  { day: 1, dot: 'weekend' },
  { day: 2, dot: 'approved' },
  { day: 3, dot: 'approved' },
  { day: 4, dot: 'approved' },
