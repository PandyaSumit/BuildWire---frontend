        ...
        <div className="rounded-lg border border-border bg-surface p-6">
          ...
          <div className="space-y-4">
            {ACTIVITY_ROWS.map((item, index) => (
              ...
              >
                <StatusDot variant={item.type} className="mt-2 h-2 w-2" />
